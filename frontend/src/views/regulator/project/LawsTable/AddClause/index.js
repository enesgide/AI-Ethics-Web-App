...
class AddClause extends Component{
    constructor(props){
        super(props);
        this.state = {
          form:{
        ...
        <div className="User-project">
          ...
          <Grid columns={2} style={{background: '#f3f3f3'}}>
                ...
                <div style={{marginTop:'4em',border:'none',marginLeft:'3em', marginRight: '3em'}}>
                  <div>
                    <div style={{display:'inline-block', fontSize: '3rem', fontFamily:'Poppins', fontWeight:'500'}}>Add Clause</div>
                ...
                <Form style={{marginTop:'4em',border:'none',marginLeft:'3em', marginRight: '3em'}}>
                  <div style={{display: 'flex', justifyContent: 'space-between'}}>
                    <div className='form-card' style={{width: '60%'}}>
                      ...
                      <Form.TextArea
                          label={<label style={{fontFamily: 'Montserrat', fontSize: '20px', fontWeight: '500'}}>Clause Description</label>}
