...
class AdministratorUserAIsupplierAdmin extends Component{
    constructor(props){
        super(props);
        this.state = {
          loading:false,
                ...
                <Grid columns={2} style={{background: '#f3f3f3'}}>
                    ...
                    <TopHeader/>
                      ...
                      <div style={{marginTop:'4em',border:'none',marginLeft:'3em', marginRight: '3em'}}>
                        <div style={{display:'inline-block', fontSize: '3rem', fontFamily:'Poppins', fontWeight:'500'}}>AI Supplier Admin List</div>
                        ...
                        <div celled color={'#A7C942'} inverted className='M-Table'>
                            {(this.state.userList||[]).map((item)=>{
                              return(
                                ...
                                <Image circular size='mini' src="/images/userimage/defaultimage.png"/> {/* Placeholder */}
                                  ...
                                  <div className='col'>
                                    <CustomButton color='red' message='Delete' value={item.username} id={item.userid} onClick={this.handleDeleteUser4}/>
                                  </div>                                  
                                </div>
                              )
                            })}
...
export default  AdministratorUserAIsupplierAdmin