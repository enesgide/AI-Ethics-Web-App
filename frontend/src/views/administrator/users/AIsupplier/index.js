...
class AdministratorUserAIsupplier extends Component{
    constructor(props){
        super(props);
        this.state = {
          loading:false,
                ...
                <Grid columns={2} style={{background: '#f3f3f3'}}>
                    ...
                    <TopHeader/>
                      ...
                      <div style={{marginTop:'4em',border:'none',marginLeft:'3em', marginRight: '3em'}}>
                        <div style={{display:'inline-block', fontSize: '3rem', fontFamily:'Poppins', fontWeight:'500'}}>AI Supplier List</div>
                        <div style={{marginTop: '4em'}}/>

                        <div color={'#A7C942'} inverted className='M-Table'>
...
export default  AdministratorUserAIsupplier