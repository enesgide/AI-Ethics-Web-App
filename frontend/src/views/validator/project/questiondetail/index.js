...
import {getQuestionnaireDetail3,postAddComment3,postAddSummary3,getPass3,getSendFeedback3, generateReport} from '../../../../api/api'
import{
    Grid,
    Input,
    Segment,
...
class QuestionDetail extends Component{
  ...
  handAddSummary = (e)=>{
    ...
    //     const data = JSON.stringify(this.state.questionDetail)
        
    //     let projectname = sessionStorage.getItem("projectname");
    //     let token = sessionStorage.getItem("token")
    //     // Call the generateReport function with the project name, data, and token
    //     generateReport(data, {}, token)
    //       .then((response) => {
                ...
                <Grid columns={2}>
                    ...
                    <TopHeader/>
                      <div id="projectdetailtable" className="content" style={{marginTop:'3em',border:'none',marginLeft:'3em', boxShadow: 'none', marginRight:'3em'}}>
                        ...
                        {this.state.questionDetail.finished? <Button positive onClick={this.onGenerateReport}>Download as PDF test1</Button>:
